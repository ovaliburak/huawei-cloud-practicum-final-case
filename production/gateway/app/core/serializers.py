...
class DemandSerializer(serializers.Serializer):
    property_type = serializers.CharField(max_length=200, required=False)
    ...
    bathroom_number = serializers.IntegerField(required=False)
    ...
    facade = serializers.CharField(required=False)
    close_to_school = serializers.BooleanField(default=False)
    close_to_hospital = serializers.BooleanField(default=False)
    close_to_railway = serializers.BooleanField(default=False)
    close_to_station = serializers.BooleanField(default=False)
    ...
    employee_is_employee = serializers.BooleanField(default=False)
    customer_id=serializers.IntegerField()
    customer_first_name = serializers.CharField(max_length=200)
    customer_last_name = serializers.CharField(max_length=200)
    customer_phone_number = serializers.CharField(max_length=50)
