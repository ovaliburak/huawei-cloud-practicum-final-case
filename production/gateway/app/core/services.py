...
class UserService:
    ...
    endpoint = "http://authentication-svc.app.svc.cluster.local:8000" + '/api/'
...
class CustomerService:
    endpoint="http://customer-svc.app.svc.cluster.local:8002" + "/api/"
...
class ProductService:
    endpoint="http://product-svc.app.svc.cluster.local:8003" + "/api/"
...
class HistoryService:
    endpoint="http://history-svc.app.svc.cluster.local:8004" + "/api/"
...
class DemandService:
    endpoint="http://demand-svc.app.svc.cluster.local:8005" + "/api/"
